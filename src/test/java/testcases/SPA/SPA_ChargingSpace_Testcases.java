...
public class SPA_ChargingSpace_Testcases extends BaseClass {
     ...
     * TC_09_Purchase_And_Extend_Charging_Space_With_PromoCode
     * TC_10_Purchase_Charging_Space_With_NewCard_and_Extend_with_ExistingCard
     * TC_11_Purchase_Charging_Space_With_NewCard_and_Extend_with_Promocode
     * TC_12_Purchase_Charging_Space_With_ExistingCard_and_Extend_with_NewCard
     * TC_13_Purchase_Charging_Space_With_ExistingCard_and_Extend_with_Promocode
     * TC_14_Purchase_Charging_Space_With_Promocode_and_Extend_with_NewCard
     * TC_15_Purchase_Charging_Space_With_Promocode_and_Extend_with_ExistingCard
     */
    ...
    /*
     * This is a test case to purchase charging space with existing vehicle and promocode
     *
     * Author : Pavan Prasad(pavanprasad.v@comakeit.com)
     */
    @Test(groups = { "smoke", "regression" })
    ...
    /*
     * This is a test case to purchase and extend charging space using promocode
     *
     * Author : Pavan Prasad(pavanprasad.v@comakeit.com)
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_09_Purchase_And_Extend_Charging_Space_With_PromoCode() {
     ...
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_10_Purchase_Charging_Space_With_NewCard_and_Extend_with_ExistingCard() {
    ...
    /*
     * This is a test case to purchase charging space with new card payment and extend with promocode
     *
     * Author : Pavan Prasad(pavanprasad.v@comakeit.com)
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_11_Purchase_Charging_Space_With_NewCard_and_Extend_with_Promocode() {
     ...
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_12_Purchase_Charging_Space_With_ExistingCard_and_Extend_with_NewCard() {
     ...
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_13_Purchase_Charging_Space_With_ExistingCard_and_Extend_with_Promocode() {
    ...
    /*
     * This is a test case to purchase charging space with promocode card payment and extend with new card
     *
     * Author : Pavan Prasad(pavanprasad.v@comakeit.com)
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_14_Purchase_Charging_Space_With_Promocode_and_Extend_with_NewCard() {
     ...
     */
    @Test(groups = { "smoke", "regression" })
    public void TC_15_Purchase_Charging_Space_With_Promocode_and_Extend_with_ExistingCard() {
