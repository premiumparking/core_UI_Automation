...
public class ProfilesPage extends BaseClass {
	...
	public void createProfile(Profile profile) {
		...
		BaseClass.driver.get("https://manage.premiumparking.com/profiles/new");
		...
		// BaseClass.driver.get("https://manage.premiumparking.com/profiles");
		clickOnButton(button_Cancel, "Cancel");
	}
	...
	public boolean isPrfileExist(String email) {
		passStep("Verifying profile : " + email);
